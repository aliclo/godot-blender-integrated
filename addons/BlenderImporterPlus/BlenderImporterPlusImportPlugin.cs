...
public partial class BlenderImporterPlusImportPlugin : EditorScenePostImportPlugin
{

	public override void _GetImportOptions(string path)
    {
        AddImportOption("Enable Blender importer plus?", false);
    }

    public override void _PostProcess(Node scene)
    {
        GD.Print(scene.GetParent().Name);
